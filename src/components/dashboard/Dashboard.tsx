...
import { PlusCircle, EyeOff, Eye, TrendingUp, CreditCard, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20 md:pl-64">
      ...
      <main className="pt-20 px-4 md:px-8 max-w-5xl mx-auto animate-fade-in">
        <div className="mb-8">
          <h2 className="text-2xl font-medium text-slate-900">Welcome back, John</h2>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <div className="flex items-center gap-2">
                  {isBalanceVisible ? (
                    <h3 className="text-3xl font-semibold">$8,250.50</h3>
                  ) : (
